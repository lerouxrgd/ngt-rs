...
// TODO: move these to mod.rs ?

// #[derive(Debug)]
// pub struct QbgProperties {
//     pub(crate) dimension: i32,
//     pub(crate) creation_edge_size: i16,
//     pub(crate) search_edge_size: i16,
//     pub(crate) object_type: QbgObject,
//     pub(crate) distance_type: QbgDistance,
//     pub(crate) raw_prop: sys::NGTProperty,
// }

// unsafe impl Send for QbgProperties {}
// unsafe impl Sync for QbgProperties {}
...
//         let object_type = QbgObject::Float;
...
//                 Err(make_err(ebuf))?
//             }
//             let object_type = QbgObject::try_from(object_type)?;

//             let distance_type = sys::ngt_get_property_distance_type(raw_prop, ebuf);
//             if distance_type < 0 {
//                 Err(make_err(ebuf))?
//             }
//             let distance_type = QbgDistance::try_from(distance_type)?;
...
//     pub fn object_type(mut self, object_type: QbgObject) -> Result<Self> {
//         self.object_type = object_type;
//         unsafe { Self::set_object_type(self.raw_prop, object_type)? };
//         Ok(self)
//     }

//     unsafe fn set_object_type(raw_prop: sys::NGTProperty, object_type: QbgObject) -> Result<()> {
//         let ebuf = sys::ngt_create_error_object();
//         defer! { sys::ngt_destroy_error_object(ebuf); }
...
//     pub fn distance_type(mut self, distance_type: QbgDistance) -> Result<Self> {
